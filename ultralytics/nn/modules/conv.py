...
class DSC:
    ...
    def _coordinate_map_3D(self, offset, if_offset):
        ...
        output_x: [B,1,W,K*H] coordinate map output_y: [B,1,K*W,H] coordinate map.
        """
    ...
    def _bilinear_interpolate_3D(self, input_feature, y, x):
        """input: input feature map [N,C,D,W,H]；coordinate map [N,K*D,K*W,K*H] output: [N,1,K*D,K*W,K*H] deformed
        feature map.
        """
